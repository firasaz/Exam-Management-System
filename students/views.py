...
from teachers.models import Teacher, Course, StudentCourseEnrollment
...
def fetch_enroll_status(request, student_id, course_id):
    ...
    enrollStatus = student.enrolled_courses().count()
...
# def EnrolledStudentsView(request):
#     count = 0
#     course1 = Course.objects.get(id=3)
#     print(course1.total_enrolled_students())
#     print(type(course1.total_enrolled_students()))
#     # for element in course1.total_enrolled_students():
#     #     count += 1
#     return JsonResponse({
#         "obj": count
#     })
