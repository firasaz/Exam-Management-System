    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=150)),
                ('description', models.TextField()),
                ('featured_img', models.ImageField(null=True, upload_to='static/images/course_imgs')),
                ...
                ('student', models.ManyToManyField(related_name='course_student', to='students.student')),
